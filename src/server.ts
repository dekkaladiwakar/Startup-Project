...
const attendance = require("./routes/api/private/attendance");
...
const events = require("./routes/api/private/occasions/event");
...
const swaggerOptions = {
  ...
  // ['.routes/*.*]
  apis: ["./src/server.ts", "./src/documentation/*Doc.yaml"],
};
...
app.use("/api/u/attendance", attendance);
...
app.use("/api/u/occasions/events", events);
